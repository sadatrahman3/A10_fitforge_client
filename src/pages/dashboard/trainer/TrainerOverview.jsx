      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-card rounded-xl p-6 flex items-center gap-4">
            ...
            <div><p className="text-2xl font-bold text-light">0</p><p className="text-muted text-sm">Classes Created</p></div>
          </div>
          <div className="bg-card rounded-xl p-6 flex items-center gap-4">
            <div className="bg-accent/20 p-4 rounded-xl"><Users size={28} className="text-accent" /></div>
            <div><p className="text-2xl font-bold text-light">0</p><p className="text-muted text-sm">Students Enrolled</p></div>
          </div>
        </div>
